  ...
  {lang === "fr" ? (
    <>
      <span className="block">
        Un service de prétraitement de données brutes dédié à l’analyse qualitative
      </span>
    </>
  ) : (
    <>
      ...
      <h2 className="mt-5 text-left text-[26px] font-medium leading-7 text-slate-500 md:mx-auto md:max-w-3xl md:text-center md:text-2xl md:leading-8">
  {lang === "fr" ? (
    <>
