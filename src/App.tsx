          ...
          <div className="space-y-3 border-l-2 border-slate-300 pl-4">
            ...
            <p className="text-[17px] md:text-[18px] leading-8 text-slate-700">
              ...
              {lang === "fr"
                ...
                : "Methods and tools are selected based on the level of data sensitivity and the ethical requirements specific to each project."}
              </p>
            </div>
            ...
            <h3 className="text-lg font-semibold text-slate-900">
              ...
              : "The objective is not systematic automation, but to determine the most appropriate method for each context."}
              </p>
            </div>
            ...
            {lang === "fr"
              ...
              : "Some corpora present a high level of sensitivity, particularly when they involve:"}
              </p>
            ...
            <li>{lang === "fr" ? "des situations de vulnérabilité (santé mentale, parcours de vie)" : "situations of vulnerability (mental health, life trajectories)"}</li>
            <li>{lang === "fr" ? "des milieux institutionnels sensibles (police, justice, milieu carcéral)" : "sensitive institutional environments (police, justice, correctional settings)"}</li>
            <li>{lang === "fr" ? "des contenus à risque (discours violents, extrémisme, situations conflictuelles)" : "high-risk content (violent discourse, extremism, conflict situations)"}</li>
            </ul>
            ...
            : "In such cases, the use of automated tools may introduce uncertainties incompatible with research requirements."}
            </p>
            ...
            <p className="text-[17px] md:text-[18px] leading-8 text-slate-700">
              ...
              <li>{lang === "fr" ? "la rétention temporaire liée aux mécanismes de sécurité" : "temporary retention related to security mechanisms"}</li>
              <li>{lang === "fr" ? "les transformations involontaires du contenu (filtrage, reformulation, atténuation)" : "unintended transformations of content (filtering, reformulation, attenuation)"}</li>
            </ul>
          </div>
            ...
            <p className="text-[17px] md:text-[18px] leading-8 text-slate-700">
              ...
              : "When required by the nature of the data, processing is carried out entirely manually."}
              </p>

              <ul className="list-disc pl-6 space-y-2 text-slate-700 text-[17px] md:text-[18px] leading-8">
                <li>{lang === "fr" ? "contrôle complet sur chaque étape" : "full control over each step"}</li>
                <li>{lang === "fr" ? "fidélité du discours et de ses nuances" : "faithfulness to speech and its nuances"}</li>
                <li>{lang === "fr" ? "préservation des éléments analytiques essentiels" : "preservation of essential analytical elements"}</li>
                <li>{lang === "fr" ? "anonymisation fine et contextualisée" : "fine-grained, contextualized anonymization"}</li>
                <li>{lang === "fr" ? "traçabilité des transformations" : "traceability of transformations"}</li>
              </ul>
          </div>
            ...
            <div className="space-y-3 border-l-2 border-slate-300 pl-4">
            <h3 className="text-lg font-semibold text-slate-900">
            {lang === "fr" ? "5. Utilisation des outils assistés par IA" : "5. Use of AI-assisted tools"}
            </h3>
