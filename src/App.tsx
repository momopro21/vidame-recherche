    ...
    function ServicesPage({ setPage }: { setPage: (page: string) => void }) {
      ...
      return (
        <div className="min-h-screen bg-white">
          {/* HERO SECTION */}
          <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-teal-950 py-20 px-4">
            ...
            <div className="relative mx-auto max-w-5xl text-center">
              ...
              <h1 className="max-w-4xl text-4xl font-semibold tracking-tight text-white md:text-6xl md:leading-[1.05]">
                ...
                <span className="text-teal-400">langage</span>,<br className="hidden md:block" />
                 la <span className="text-teal-400">recherche</span> et les{" "}
                <span className="text-teal-400">données</span>
              </h1>
            ...
            {activeTab === "carte" && (
              ...
              >
                ...
                <div className="mt-12 rounded-3xl border border-slate-200 bg-slate-50 p-8 text-center">
                  <h3 className="text-xl font-semibold text-slate-900">Prêt à soumettre une demande ?</h3>
                  <p className="mt-2 text-sm text-slate-500">Obtenez une soumission personnalisée en moins de 48 heures.</p>
                  <Button className="mt-6 rounded-2xl" size="lg" onClick={() => setPage("soumission")}>
