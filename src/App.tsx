...
<h1 className="text-left text-[28px] font-[350] leading-[1.05] text-slate-800 md:mx-auto md:max-w-5xl md:text-center md:text-[48px]">
  {lang === "fr" ? (
    <>
    ...
    <>
      ...
      <h2 className="mt-5 text-left text-[24px] font-medium leading-7 text-slate-500 md:mx-auto md:max-w-2xl md:text-center md:text-3xl md:leading-8">
  {lang === "fr" ? (
    <>
...
<div className="mt-8 text-left text-[20px] leading-7 md:mx-auto md:max-w-xl md:text-center md:text-[20px]">
  {lang === "fr" ? (
    <>
      <p>
