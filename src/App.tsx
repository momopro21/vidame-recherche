...
<h2 className="text-3xl font-semibold text-slate-900 md:text-4xl leading-tight">
  {lang === "fr"
    ...
    : "For more sensitive data processing"}
</h2>
  ...
  <div className="space-y-3 border-l-2 border-slate-300 pl-4">
    ...
    <p className="text-[17px] md:text-[18px] leading-8 text-slate-700">
      {lang === "fr"
        ...
        : "The objective is not to automate systematically, but to determine the method most appropriate to the context."}
    </p>
  </div>
    ...
    <ul className="list-disc pl-6 space-y-2 text-slate-700 text-[17px] md:text-[18px] leading-8">
      ...
      <li>
        {lang === "fr"
          ...
          : "sensitive institutional settings (policing, justice, correctional environments)"}
      </li>
      <li>
        {lang === "fr"
    ...
    <ul className="list-disc pl-6 space-y-2 text-slate-700 text-[17px] md:text-[18px] leading-8">
      ...
      <li>
        {lang === "fr"
          ...
          : "temporary retention related to security mechanisms"}
      </li>
      <li>
        {lang === "fr"
    ...
    <ul className="list-disc pl-6 space-y-2 text-slate-700 text-[17px] md:text-[18px] leading-8">
      ...
      <li>
        {lang === "fr"
          ...
          : "fine-grained, contextualized anonymization"}
      </li>
